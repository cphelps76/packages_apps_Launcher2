...
public class IconPackHelper {
    ...
    public static void pickIconPack(final Context context) {
        ...
        String iconPack = PreferencesProvider.Interface.Icons.getIconPack();
        ...
        builder.setSingleChoiceItems(dialogEntries, selectedIndex, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (selectedPackage.equals(defaultIcons)) {
                    PreferencesProvider.Interface.Icons.setIconPack(context, "");
                } else {
                    PreferencesProvider.Interface.Icons.setIconPack(context, supportedPackages.get(selectedPackage));
                }
                dialog.dismiss();
            }
        });
